...
(function () {
    ...
    function localize() {
        ...
        if (currentLanguageEle) {
            // ✅ tandai aktif, tapi jangan klik ulang (karena bisa trigger reset)
            document
                .querySelectorAll(".dropdown-item[data-language]")
    ...
    if (
        ...
        typeof window.templateCustomizer.settings.defaultMenuCollapsed !==
            "undefined"
    ) {
