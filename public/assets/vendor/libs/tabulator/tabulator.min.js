...
!(function (e, t) {
    ...
    class R extends e {
        ...
        check(e, t, i) {
            ...
            return (
                ...
                t
                    ? ((s =
                          s + ", Please use the %c" + t + "%c option instead"),
                      this._warnUser(
                          s,
                          "font-weight: bold;",
                          "font-weight: normal;",
            ...
            range: function (e) {
                ...
                return (
                    ...
                    a &&
                        ...
                        i &&
                            ((s = (r =
                                this.table.rowManager.activeRows.slice()).indexOf(
                                i.row
                            )),
        ...
        initializeColumn(e) {
            ...
            if (t.topCalc) {
                switch (typeof t.topCalc) {
                    case "string":
                        J.calculations[t.topCalc]
                            ? (i.topCalc = J.calculations[t.topCalc])
                            : console.warn(
            ...
            if (t.bottomCalc) {
                switch (typeof t.bottomCalc) {
                    case "string":
                        J.calculations[t.bottomCalc]
                            ? (i.botCalc = J.calculations[t.bottomCalc])
                            : console.warn(
                                  "Column Calc Error - No such calculation found, ignoring: ",
                                  t.bottomCalc
                              );
                ...
                a.addEventListener("keydown", function (e) {
                    switch (e.keyCode) {
                        case 39:
                            e.preventDefault(),
                                (m.style.width =
                                    m.clientWidth + a.clientWidth / 100 + "px");
                            break;
                        case 37:
                            e.preventDefault(),
                                (m.style.width =
                ...
                (o =
                    !1 !== this.config.columnHeaders
                        ? this.headersToExportRows(
                              this.generateColumnGroupHeaders(r)
                          )
                        : []),
                    (n = this.bodyToExportRows(
                        this.rowLookup(i),
                        this.table.modules.selectRange.selectedColumns(!0)
                    ));
                ...
                (e = e.filter((e) => {
                    ...
                    switch (e.type) {
                        case "group":
                            (r = e.level),
                                n.push(
                                    new te(e.key, e.getComponent(), t.length, 1)
                                );
                            break;
                        case "calc":
                        case "row":
                ...
                e.columns.forEach((o, n) => {
                    if (o) {
                        ...
                        if (
                            ...
                            c = this.table.modules.format.formatExportValue(
                                u,
                                this.colVisProp
                            );
                        else
        ...
        rownum: function (e, t, i) {
            ...
            return (
                o.watchPosition((e) => {
                    t.relativeToPage &&
                        (e +=
                            n.modules.page.getPageSize() *
                            (n.modules.page.getPage() - 1)),
                        (s.innerText = e);
                }),
                s
            );
                ...
                if (
                    ...
                    n instanceof u
                        ? (s.addEventListener("change", (e) => {
                              "click" ===
                                  this.table.options.selectableRowsRangeMode &&
                              o
                                  ? (o = !1)
                                  : n.toggleSelect();
                          }),
                    ...
                    t.includes(n) || (this.layoutElement(n, s), t.push(n)),
                        n.classList.toggle(
                            ...
                            s.modules.frozen.edge &&
                                "left" === s.modules.frozen.position
                        ),
                        n.classList.toggle(
                            "tabulator-frozen-right",
                            s.modules.frozen.edge &&
                                "right" === s.modules.frozen.position
                        );
            ...
            return (
                (t = t || []).forEach((t, o) => {
                    ...
                    r &&
                        ...
                        r.columns &&
                            (r.columns = this.mergeDefinition(
                                r.columns,
                                t.columns
                            )),
                        s.push(r));
        ...
        initialize() {
            this.deprecatedOptionsCheck(),
                ...
                !1 !== this.table.options.selectableRows &&
                    ...
                    this.subscribe(
                        "rows-wipe",
                        this.clearSelectionData.bind(this)
                    ),
                    this.subscribe(
                        "rows-retrieve",
                        this.rowRetrieve.bind(this)
                    ),
    ...
    class Be {
        ...
        clearValues() {
            this._range.destroyedGuard("clearValues") &&
    ...
    class Ve extends e {
        ...
        layout() {
            ...
            null == r && (r = 0),
                ...
                this.overlaps(l, r, h, a) &&
                    ...
                    (this.element.style.left =
                        o.row.getElement().offsetLeft +
                        o.getElement().offsetLeft +
                        "px"),
                    (this.element.style.top =
                        o.row.getElement().offsetTop + "px"),
                    (this.element.style.width =
                        n.getElement().offsetLeft +
                        n.getElement().offsetWidth -
                        o.getElement().offsetLeft +
                        "px"),
                    (this.element.style.height =
                        n.row.getElement().offsetTop +
                        n.row.getElement().offsetHeight -
                        o.row.getElement().offsetTop +
                        "px"));
        }
        atTopLeft(e) {
            return (
        ...
        occupiesColumn(e) {
            return (
                this.left <= e.getPosition() - 1 &&
                e.getPosition() - 1 <= this.right
            );
        }
        overlaps(e, t, i, s) {
            return !(
    ...
    class Ie extends k {
        ...
        initializeWatchers() {
            (this.columnSelection = this.options("selectableRangeColumns")),
                ...
                this.subscribe(
                    "column-resized",
                    this.handleColumnResized.bind(this)
                ),
            ...
            return (
                ...
                s
                    ? ((l = this.getRowByRangePos(o.end.row)),
                      ...
                      ("left" !== i && "right" !== i) ||
                      null !== h.getElement().parentNode
                          ? ("up" !== i && "down" !== i) ||
                            null !== l.getElement().parentNode
                              ? this.autoScroll(
                                    o,
                                    l.getElement(),
                                    h.getElement()
        ...
        findJumpCellLeft(e, t) {
            var i = this.getRowByRangePos(e).cells.filter(
                    (e) => e.column.visible
                ),
                s = !i[t].getValue(),
                o = !!i[t] && !i[t].getValue(),
        ...
        findJumpCellUp(e, t) {
            var i = this.getColumnByRangePos(t).cells.filter((e) =>
                    this.table.rowManager.activeRows.includes(e.row)
                ),
                s = !i[e].getValue(),
        ...
        autoScroll(e, t, i) {
            ...
            void 0 === t && (t = this.getRowByRangePos(e.end.row).getElement()),
                ...
                r ||
                    (o.left < n.left
                        ? ((l.scrollLeft = o.left),
                          s && (l.scrollLeft -= s.offsetWidth))
                        : o.right > n.right &&
                          (l.scrollLeft = o.right - l.clientWidth)),
                a ||
                    (o.top < n.top
                        ? (l.scrollTop = o.top)
                        : o.bottom > n.bottom &&
                          (l.scrollTop = o.bottom - l.clientHeight));
        }
        layoutChange() {
        ...
        layoutRanges() {
            ...
            this.table.initialized &&
                ...
                ((this.activeRangeCellElement.style.left =
                    e.row.getElement().offsetLeft +
                    e.getElement().offsetLeft +
                    "px"),
                (this.activeRangeCellElement.style.top =
                    e.row.getElement().offsetTop + "px"),
                (this.activeRangeCellElement.style.width =
                    e.getElement().offsetLeft +
                    e.getElement().offsetWidth -
                    e.getElement().offsetLeft +
                    "px"),
                (this.activeRangeCellElement.style.height =
                    e.row.getElement().offsetTop +
                    e.row.getElement().offsetHeight -
                    e.row.getElement().offsetTop +
                    "px"),
        ...
        resetRanges() {
            ...
            return (
                ...
                this.table.rowManager.activeRows.length &&
                    (t =
                        this.table.rowManager.activeRows[0].cells[
                            this.rowHeader ? 1 : 0
                        ]) &&
                    (e.setBounds(t), this.initializeFocus(t)),
                e
            );
        }
        tableDestroyed() {
