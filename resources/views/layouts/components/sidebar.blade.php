 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
     <div class="app-brand" style="padding-top:1rem">
         <a href="{{ url('/') }}" class="app-brand-link">
             ...
             <span class="app-brand-text demo menu-text fw-bold ms-2">Delta Surya</span>
         </a>
     ...
     <ul class="menu-inner py-1">
         ...
         @if (Auth::user()->role == 'pharmacist')
             <!-- Resep -->
             <li class="menu-item {{ $activeController === 'ResepController' ? 'active' : '' }}">
                 <a href="{{ route('resep.index') }}" class="menu-link">
                     <i class="menu-icon tf-icons fa-solid fa-laptop-medical"></i>
                     <div data-i18n="E-Resep">E-Resep</div>
                 </a>
             </li>
         @endif
         ...
         @if (Auth::user()->role == 'doctor')
             <!-- RAWAT JALAN -->
             <li class="menu-item {{ $activeController === 'RawatJalanController' ? 'active' : '' }}">
                 <a href="{{ route('rajal.index') }}" class="menu-link">
                     <i class="menu-icon fa-solid fa-person-walking"></i>
                     <div data-i18n="Rawat Jalan">Rawat Jalan</div>
                 </a>
             </li>
         @endif
